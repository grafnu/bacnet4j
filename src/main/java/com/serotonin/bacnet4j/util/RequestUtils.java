...
public class RequestUtils {
    ...
    /*
    public static void setPresentValueWithPriority(LocalDevice localDevice, RemoteDevice d, ObjectIdentifier oid, Encodable value,int priority)
            throws BACnetException {
    	localDevice.send(d, new WritePropertyRequest(oid, PropertyIdentifier.presentValue, null, value, priority));
    }*/
}
